...
public class ShaderLesson6 implements ApplicationListener {
	...
	@Override
	public void create() {
		rock = new Texture(Gdx.files.internal("assets/images/cursor.png"));
		rockNormals = new Texture(Gdx.files.internal("assets/images/cursor_n.png"));
